...
namespace ModulesInAction
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //загружаем сборку
            Assembly asm = Assembly.Load(AssemblyName.GetAssemblyName("D:\\WindowsApp\\Desktop\\Видео Прогр2\\Sources1\\ModulesInAction\\SampleLibrary\\bin\\Debug\\SampleLibrary.dll"));
